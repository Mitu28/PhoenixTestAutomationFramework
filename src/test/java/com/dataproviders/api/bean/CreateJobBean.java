...
public class CreateJobBean {
    ...
    @CsvBindByName(column = "customer__mobile_numbere")
    ...
    @CsvBindByName(column = "customer__email_i")
    private String  customer__email_i;
    ...
    @CsvBindByName(column = "customer_address__landmar")
    private String customer_address__landmar;
    ...
    public String getCustomer__email_i() {
        return customer__email_i;
    }

    public void setCustomer__email_i(String customer__email_i) {
        this.customer__email_i = customer__email_i;
    }
    ...
    public String getCustomer_address__landmar() {
        return customer_address__landmar;
    }

    public void setCustomer_address__landmar(String customer_address__landmar) {
        this.customer_address__landmar = customer_address__landmar;
    }
    ...
    public String toString() {
        return "CreateJobBean{" +
                ...
                ", customer__email_i='" + customer__email_i + '\'' +
                ...
                ", customer_address__landmar='" + customer_address__landmar + '\'' +
